...
protected:
    void fillSearchResponse(const demoserver::EntitySearchRequest& request, demoserver::EntitySearchResponse& response, const indexing::SearchResult& result) {
    ...
    virtual void fillEntity(demoserver::DetailedEntity*, sae::io::VertexIterator*) = 0;
