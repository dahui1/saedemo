...
class KnowledgeDrift(object):
    def __init__(self, data_set="patent"):
    ...
    def search_document_by_author(self, a, start_time=0, end_time=10000):
        ...
        if self.data_set == "academic":
            ...
            result = client.patent_search_by_inventor(self.data_set, a.id)
    ...
    def search_author(self, q, time_window, start_time, end_time):
        ...
        for qu in q:
            if self.data_set == "academic":
                self.author_result.extend(client.author_search(self.data_set, qu, 0, 50).entity)
            elif self.data_set == "patent":
                for e in client.inventor_search(self.data_set, qu, 0, 50).entity:
                    if len(e.title) > 2:
